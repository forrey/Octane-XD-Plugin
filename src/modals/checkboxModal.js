...
async function checkboxDialog(selection) {
    ...
    try {
        ...
        if (response === 'reasonCanceled') {
            ...
            */
            ...
            let options = {
               text: dialog.querySelector('#checkboxLabel').value,
               checked: dialog.querySelector('#checkboxChecked').checked
            }

            const createCheckbox = require('../functions/checkboxes.js');
