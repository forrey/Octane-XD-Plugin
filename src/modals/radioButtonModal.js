const {buildDropdown, buildTextField, buildInfoText, buildCheckbox} = require('../helpers/modalHelpers.js');
...
async function radioButtonDialog(selection) {
    ...
    try {
        ...
        if (response === 'reasonCanceled') {
            ...
            */
            ...
            let options = {
               text: dialog.querySelector('#radioButtonLabel').value,
               checked: dialog.querySelector('#radioButtonSelected').checked
            }

            const createRadioButton = require('../functions/radioButtons.js');
...
module.exports = radioButtonDialog;