...
async function toggleDialog(selection) {
   ...
   try {
      ...
      if (response === 'reasonCanceled') {
         ...
         */
         ...
         let options = {
            state: dialog.querySelector('#toggleState').value,
            label: dialog.querySelector('#toggleLabel').value
         }
         
         const createToggle = require('../functions/toggles.js');
